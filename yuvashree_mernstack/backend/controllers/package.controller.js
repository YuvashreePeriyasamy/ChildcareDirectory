...
var gateway = new braintree.BraintreeGateway({
  ...
  merchantId: process.env.BRAINTREE_MERCHANT_ID || "9fwqn4z5scf3hdv9",
  publicKey: process.env.BRAINTREE_PUBLIC_KEY || "ny9tbdwhj3tjmmgj",
  privateKey:
    process.env.BRAINTREE_PRIVATE_KEY || "d26551a2e55cddd267dc69ac0c9257dc",
});
