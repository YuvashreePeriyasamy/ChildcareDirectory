    ...
    <div className="main w-full">
      <div className="w-full flex flex-col">
        ...
        <div className="top-part w-full gap-2 flex flex-col">
          ...
          Find Your DayCare helps parents locate suitable daycare options for their children.
          </h1>
        ...
        <div className="main p-6 flex flex-col gap-5">
          ...
          {!loading &&
            ...
            offerPackages.length === 0 && (
              <h1 className="text-center text-2xl">No Daycares Yet!</h1>
            )}
          {/* Top Rated */}
          {!loading && topPackages.length > 0 && (
            <>
              <h1 className="text-2xl font-semibold">Explore Daycares</h1>
